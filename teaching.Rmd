...
ggplot(teaching1, aes(q_challenging, group=course_num, colour=course_num)) + 
...
```{r, warning=FALSE, echo = FALSE, message=FALSE}
teaching1$course_num <- as.factor(teaching1$course_num)
ggplot(teaching1, aes(q_listen, group=course_num, colour=course_num)) + 
  geom_density(position='dodge') + 
  xlim(1, 5) + 
  labs(colour = "Course Number") + 
  scale_colour_manual(values = custom_colors) +
...
teaching1$course_num <- as.factor(teaching1$course_num)
ggplot(teaching1, aes(q_helpful, group=course_num, colour=course_num)) + 
  geom_density(position='dodge') + 
  xlim(1, 5) + 
  labs(colour = "Course Number") + 
  scale_colour_manual(values = custom_colors) +
...
teaching1$course_num <- as.factor(teaching1$course_num)
ggplot(teaching1, aes(q_interest_in_learning, group=course_num, colour=course_num)) + 
  geom_density(position='dodge') + 
  xlim(1, 5) + 
  labs(colour = "Course Number") + 
  scale_colour_manual(values = custom_colors) +
...
teaching1$course_num <- as.factor(teaching1$course_num)
ggplot(teaching1, aes(q_material_helped_learn, group=course_num, colour=course_num)) + 
  geom_density(position='dodge') + 
  xlim(1, 5) + 
  labs(colour = "Course Number") + 
  scale_colour_manual(values = custom_colors) +
...
teaching1$course_num <- as.factor(teaching1$course_num)
ggplot(teaching1, aes(q_atmosphere_good, group=course_num, colour=course_num)) + 
  geom_density(position='dodge') + 
  xlim(1, 5) + 
  labs(colour = "Course Number") + 
  scale_colour_manual(values = custom_colors) +
...
```{r, warning=FALSE, echo = FALSE, message=FALSE}
teaching1$course_num <- as.factor(teaching1$course_num)
ggplot(teaching1, aes(q_mutual_respect, group=course_num, colour=course_num)) + 
  geom_density(position='dodge') + 
  xlim(1, 5) + 
  labs(colour = "Course Number") + 
  scale_colour_manual(values = custom_colors) +
...
```{r, warning=FALSE, echo = FALSE, message=FALSE}
teaching1$course_num <- as.factor(teaching1$course_num)
ggplot(teaching1, aes(q_class_discussion, group=course_num, colour=course_num)) + 
  geom_density(position='dodge') + 
  xlim(1, 5) + 
  labs(colour = "Course Number") + 
  scale_colour_manual(values = custom_colors) +
...
```{r, warning=FALSE, echo = FALSE, message=FALSE}
teaching1$course_num <- as.factor(teaching1$course_num)
ggplot(teaching1, aes(q_share_ideas, group=course_num, colour=course_num)) + 
  geom_density(position='dodge') + 
  xlim(1, 5) + 
  labs(colour = "Course Number") + 
  scale_colour_manual(values = custom_colors) +
...
```{r, warning=FALSE, echo = FALSE, message=FALSE}
teaching1$course_num <- as.factor(teaching1$course_num)
ggplot(teaching1, aes(q_motivated, group=course_num, colour=course_num)) + 
  geom_density(position='dodge') + 
  xlim(1, 5) + 
  labs(colour = "Course Number") + 
  scale_colour_manual(values = custom_colors) +
